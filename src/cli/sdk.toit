...
class Sdk:
  ...
  */
  flash
    ...
    if not is-dev-setup and partition-table-path and (semver.compare version "v2.0.0-alpha.166") < 0:
      throw "Partition tables are not supported for SDK versions older than v2.0.0-alpha.166."
