...
literal_block new_bytes/ByteArray fd --with_header=false --with_footer=false -> int:
  initial_state := InitialState_.no_old_bytes new_bytes --with_header=with_header
