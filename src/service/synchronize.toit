...
class SynchronizeJob extends Job:
  ...
  handle_new_config_ resources/ResourceManager new_config/Map -> none:
  ...
  handle_firmware_update_ resources/ResourceManager id/string -> none:
    ...
    bundle := ActionBundle new_config
    bundle.add (ActionFirmwareUpdate actions_ resources id)
    actions_.add bundle
              ...
              if topic == device.topic_revision:
                ...
                if new_revision != revision:
                  ...
                  if new_config and revision == new_config["revision"]:
                    handle_new_config_ resources new_config
                else:
                  handle_nop_
