...
run_test test_cli/TestCli fleet_dir/string:
  ...
  groups := test_cli.run --json ["fleet", "group", "list"]
  ...
  test_cli.run ["fleet", "group", "create", "test-group-5", "--force"]
  test_cli.run ["fleet", "group", "move", "--to", "test-group-5", "--group", "default"]
