...
import artemis.cli.fleet-storage-fs show FilesystemFleetStorage
import expect show *
import .utils
...
run-test fleet/TestFleet:
  ...
  devices-file := fleet-lib.FleetWithDevices.load-devices-file (FilesystemFleetStorage --root=fleet.fleet-dir --cli=fleet.tester.cli) --cli=fleet.tester.cli
  ...
  device-file := fleet-lib.FleetWithDevices.load-devices-file (FilesystemFleetStorage --root=fleet.fleet-dir --cli=fleet.tester.cli) --cli=fleet.tester.cli
